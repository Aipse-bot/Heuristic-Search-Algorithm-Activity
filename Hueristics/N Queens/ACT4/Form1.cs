...
namespace ACT4
{
    public partial class Form1 : Form
    {
        ...
        private void updateBeam()
        {
            ...
            {
                var possibleMoves = getBestMoves(getHeuristicTableForPossibleMoves(state));
                foreach (var move in possibleMoves)
                {
                    var newState = new SixState(state);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            while (beam.Any(s => getAttackingPairs(s) > 0))
            {
                updateBeam();
            }
        }
